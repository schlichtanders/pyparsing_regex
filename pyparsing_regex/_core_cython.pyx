...
class ParserElement(ParserElementType):
    ...
    def _parse_preprocess(match):
        ...
        """
        cdef map[int, vector[int]] match_ends
        cdef map[int, vector[string]] match_captures
        ...
        def preprocess_func(leaf):
            ...
            if isinstance(leaf, Repeated):
                ...
                match_ends[new_leaf] = match.ends(new_leaf + 1)[::-1]
                # recursive call
            ...
            # elif isinstance(leaf, Count):
                ...
                # CAUTION: +1 as we now start counting at 0
                match_captures[new_leaf] = match.captures(new_leaf + 1)[::-1]
